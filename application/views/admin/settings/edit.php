...
<form method="post" action="<?php echo base_url() ?>admin/settings/edit/<?php echo $category->id ?>"?>>
	<div class="row">	
	  <div class="col-md-6">
	  	<h1 class="sub-header">Edit Category</h1>
			...
			<div class="form-group col-xs-3">
				...
				<input type="text" class="form-control" name="name" value="<?php echo $setting->value; ?>" placeholder="Enter Category Name" />
				<br />
