        ...
        <nav>
          <ul class="nav nav-pills pull-right navbar-padding">
			...
			<?php foreach($navbar_items as $item): ?>
            	<li <?php if ($item->id == $article->id){ echo 'class="active"';} ?> role="presentation"><a class="btn" href="<?php echo base_url();?>articles/view/<?php echo $item->id;?>"><?php echo $item->title; ?></a></li>
          	<?php endforeach ; ?>
          </ul>
        </nav>
